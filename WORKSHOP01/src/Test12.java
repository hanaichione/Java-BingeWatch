...
public class Test12 {
	...
	public static void main(String[] args) {
		...
		System.out.println("1번째 위치 문자: "+mesg.charAt(0));
		System.out.println("문자열 연결: "+mesg.concat(" ~~~"));
		System.out.println("h 문자열 포함여부: "+mesg.contains("he"));
		System.out.println("h 문자열 포함여부: "+mesg.contains("hw"));
		System.out.println("h 문자로 끝나는지 여부: "+mesg.endsWith("h"));
		System.out.println("h 문자로 끝나는지 여부: "+mesg.startsWith("h"));
